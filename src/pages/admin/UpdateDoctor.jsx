      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.12)]">
        ...
        <form onSubmit={formik.handleSubmit} className="p-6 space-y-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50/50 p-4 rounded-xl hover:bg-gray-50 transition-all duration-300">
              <label className="block text-sm font-semibold text-gray-700 mb-1.5">Chuyên khoa</label>
              <select
                name="specialization"
            ...
            <div className="bg-gray-50/50 p-4 rounded-xl hover:bg-gray-50 transition-all duration-300">
              <label className="block text-sm font-semibold text-gray-700 mb-1.5">Bằng cấp</label>
              <select
                name="qualification"
            ...
            <div className="bg-gray-50/50 p-4 rounded-xl hover:bg-gray-50 transition-all duration-300">
              <label className="block text-sm font-semibold text-gray-700 mb-1.5">Số giấy phép</label>
              <input
                type="text"
                name="licenseNumber"
