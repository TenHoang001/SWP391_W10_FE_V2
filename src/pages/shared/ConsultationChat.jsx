...
const ConsultationChat = () => {
  ...
  const totalPages = Math.ceil((consultation?.consultationResponses?.length || 0) / COMMENTS_PER_PAGE);
    ...
    <div className="max-w-3xl mx-auto p-4">
      <div className="bg-white rounded-lg shadow p-4 mb-6">
        <h2 className="text-xl font-semibold mb-2">
          Tham vấn cho trẻ: {consultation?.child?.fullName}
        </h2>
        ...
        <div className="bg-white rounded-lg shadow p-4 mb-6">
          <form onSubmit={handleSendMessage}>
            <textarea
              ...
              placeholder={userRole === 'Doctor' ? "Nhập câu trả lời..." : "Nhập câu hỏi..."}
            ...
            <div className="flex justify-between">
              ...
              {userRole === 'User' && consultation?.status === 'Assigned' && (
                <button
                  type="button"
                  onClick={() => CompleteConsultationRequestAPI(requestId)}
